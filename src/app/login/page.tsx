...
//               </div>
//             </div>
//             <div className="w-[400px] h-[40px] bg-gradient-to-r from-[#97329f] via-[#97329f] to-[#012727] flex flex-row items-center justify-center gap-4 cursor-pointer" onClick={login}>
//               <div className="">
...
//                 <button className="text-white font-light" onClick={login}>Login</button>
//               </div>
//             </div>
